...
def applytrf(fixed_file, moving_file, transformlist, transform_file):
    ...
    """
    apply_transforms(
        fixed_file=fixed_file, moving_file=moving_file,
        transformlist=transformlist, filename=transform_file)
