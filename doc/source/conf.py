...
cmd = ["sphinxdoc", "-v 2", "-p",  installdir, "-n", "limri", "-o", "..",
       "-i", "limri"]
...
sphinx_gallery_conf = {
    "doc_module": "limri",
    "backreferences_dir": os.path.join("limri", "gallery"),
    "examples_dirs": os.path.join(os.pardir, "examples"),
    "gallery_dirs": "auto_gallery",
    "reference_url": {"limri": None}}
...
project = u"limri"
copyright = u"""{0}, limri developers <antoine.grigis@cea.fr>""".format(
...
# [howto/manual]).
latex_documents = [
    ("index", "limri.tex", "limri Documentation", """limri developers""",
     "manual"),
]
